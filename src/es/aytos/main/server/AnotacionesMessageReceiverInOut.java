 ...
 */
        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("leer".equals(methodName)){
                
                es.aytos.main.LeerResponse leerResponse8 = null;
	                        es.aytos.main.Leer wrappedParam =
                                                             (es.aytos.main.Leer)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    es.aytos.main.Leer.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               leerResponse8 =
                                                   
                                                   
                                                         skel.leer(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), leerResponse8, false);
